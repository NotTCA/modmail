...
module.exports = (client) => {
  ...
  client.on("messageCreate", async (message) => {
    if (message.guild && !message.author.bot) {
            ...
            .reply({
              embeds: [
                new Discord.MessageEmbed()
                  .setColor("BLURPLE")
                  .setTitle(
                    `:white_check_mark: **My prefix is: \`${prefix}\`**`
                  ),
              ],
            })
            .catch(console.error);
        ...
        if (cmd && cmd.length > 0) {
          if (cmd == "invite" || cmd == "add") {
            message.reply({
              embeds: [
                new Discord.MessageEmbed()
                  .setColor("BLURPLE")
                  .setTitle(
                    `:x: **I am a private bot, so you cannot invite me!**`
                  ),
              ],
            });
          } else if (cmd == "setup") {
                ...
                .reply({
                  embeds: [
                    new Discord.MessageEmbed()
                      .setAuthor(
                        serverauthor.tag,
                        serverauthor.displayAvatarURL({ dynamic: true })
                      )
                      .setTimestamp()
                      .setFooter(
                        `ID: ${serverauthor.id}`,
                ...
                .reply({
                  embeds: [
                    new Discord.MessageEmbed()
                      ...
                      .setDescription(
                        `Usage: \`${config.prefix}setup <Category ID> [TICKETOPENINGMESSAGE]\`\n**Category ID** = the ID of the Category where the support channels should go!\n**TICKETOPENINGMESSAGE** = the message which should be sent into the DMS once the TICKET/MODMAIL gets opened!!`
                      ),
                  ],
                })
                .catch(console.error);
                ...
                .reply({
                  embeds: [
                    new Discord.MessageEmbed()
                      ...
                      .setDescription(
                        `${args[0]} is not a category ID!`.substr(0, 2048)
                      ),
                  ],
                })
                .catch(console.error);
            ...
            client.modmailDb.set(message.guild.id, {
              ...
              message: args[1]
                ? args.slice(1).join(" ").substr(0, 2000)
                : "Start typing what you need and get help!",
            });
            return message
              .reply({
                embeds: [
                  new Discord.MessageEmbed()
                    ...
                    .setColor("GREEN")
                    .setTitle(
                      "✅ Successfully enabled and configurated the setup!"
                    ),
                ],
              })
              .catch(console.error);
                ...
                .reply({
                  embeds: [
                    new Discord.MessageEmbed()
                      ...
                      .setColor("RED")
                      .setTitle(
                        "❌ Only admins are allowed to use this commanda!"
                      ),
                  ],
                })
                .catch(console.error);
                ...
                .reply({
                  embeds: [
                    new Discord.MessageEmbed()
                      ...
                      .setColor("RED")
                      .setTitle("❌ This server has never been set up before!"),
                  ],
                })
                .catch(console.error);
            }
            ...
            if (data.category == message.channel.parentId) {
              let authorId = client.modmailDb.findKey(
                (d) =>
                  d.id == message.guild.id && d.channel == message.channel.id
              );
                ...
                .reply({
                  embeds: [
                    new Discord.MessageEmbed()
                      ...
                      .setDescription(
                        `YOYou can now safely delete this channel!`
                      ),
                  ],
                })
                .catch(console.error);
            ...
            if (data.category == message.channel.parentId) {
                  ...
                  .reply({
                    embeds: [
                      new Discord.MessageEmbed()
                        ...
                        .setColor("RED")
                        .setTitle(
                          "❌ This ticket has been closed! (or the user left the server!)"
                        )
                        .setDescription(
                          `Force close this ticket with: \`${config.prefix}forceclose\`\nAfter that, you can safely delete this channel!`
                        ),
                    ],
                  })
                  .catch(console.error);
              ...
              if (!author)
                author = await message.guild.members
                  .fetch(authorId)
                  .catch((e) => {
                    console.log(e);
                    return message
                      .reply({
                        embeds: [
                          new Discord.MessageEmbed()
                            ...
                            .setDescription(
                              `Close the Ticket with: \`${config.prefix}close\``
                            ),
                        ],
                      })
                      .catch(console.error);
                  ...
                  .reply({
                    embeds: [
                      new Discord.MessageEmbed()
                        ...
                        .setTitle("❌ The user left the server.")
                        .setDescription(
                          `Close the Ticket with: \`${config.prefix}forceclose\``
                        ),
                    ],
                  })
                  .catch(console.error);
              ...
              try {
                attachment = [
                  await create_transcript_buffer(
                    [...messageCollection.values()],
                    message.channel,
                    message.guild
                  ),
                ];
                ...
                .reply({
                  ...
                  embeds: [
                    new Discord.MessageEmbed()
                      ...
                      .setTitle("✅ Supporter closed the ticket.")
                      .setDescription(
                        `You can now safely delete this channel!`
                      ),
                  ],
                })
                .catch(console.error);
              try {
                fs.unlinkSync(`${process.cwd()}/${message.channel.name}.html`);
              } catch (e) {
                console.log(e);
              }
            } else {
            ...
            embeds.push(
              new Discord.MessageEmbed()
                ...
                .setTitle(`HELP MENU`)
                .setDescription(
                  `Hello I am ${guild.me.user.username} and I am a ModMail bot.\n> A Modmail Bot is a bot similar to a Ticket Bot which allows you to DM with The Ticket User instead of creating a ticket! It's easier for them, and easier for staff.\n\n**My commands are listed below.**\n\nOriginally made by \`Tomato#6966\`. [Click me for source code!](https://github.com/NotTCA/modmail)`
                )
                .addField(
                  "<:Discord:787321652345438228> **Support Server**",
                  `> Join my [Support Server](https://discord.gg/milrato)`
                )
            ...
            embeds.push(
              new Discord.MessageEmbed()
                ...
                .addFields([
                  ...
                  {
                    name: "**invite**",
                    value: `> *Gives you an invite link!*`,
                    inline: true,
                  },
                ])
            );
            embeds.push(
              new Discord.MessageEmbed()
                ...
                .addFields([
                  {
                    name: "**setup**",
                    value: `> *Creates the setup for this server.*`,
                    inline: true,
                  },
                  {
                    name: "**deletesetup**",
                    value: `> *Deletes the setup for this server.*`,
                    inline: true,
                  },
                  {
                    name: "**prefix**",
                    value: `> *Changes my prefix for this server!*`,
                    inline: true,
                  },
                  ...
                  {
                    name: "**forceclose**",
                    value: `> *Force closes the ticket so that you can safely delete the channel.*`,
                    inline: true,
                  },
                ])
            ...
            message
              .reply({
                embeds: [
                  new Discord.MessageEmbed()
                    .setColor("BLURPLE")
                    .setTitle(`:white_check_mark: **Pinging the API...**`),
                ],
              })
              .then((msg) => {
                let botping =
                  Date.now() - msg.createdTimestamp - 2 * client.ws.ping;
                ...
                .reply({
                  embeds: [
                    new Discord.MessageEmbed()
                      .setColor("RED")
                      .setTitle(
                        `:x: **You are not allowed to run this command.**`
                      ),
                  ],
                })
                .catch(console.error);
                ...
                .reply({
                  embeds: [
                    new Discord.MessageEmbed()
                      .setColor("RED")
                      .setTitle(
                        `:x: **You need to tell me what the new prefix should be!**`
                      ),
                  ],
                })
                .catch(console.error);
              ...
              .reply({
                embeds: [
                  new Discord.MessageEmbed()
                    .setColor("BLURPLE")
                    .setTitle(
                      `:white_check_mark: **Successfully changed the prefix to: \`${args[0]}\`**`
                    ),
                ],
              })
              .catch(console.error);
      ...
      if (data.category == message.channel.parentId) {
        let authorId = client.modmailDb.findKey(
          (d) => d.id == message.guild.id && d.channel == message.channel.id
        );
        if (!authorId)
          return message
            .reply({
              embeds: [
                new Discord.MessageEmbed()
                  ...
                  .setColor("RED")
                  .setTitle(
                    "❌ This channel has been closed! (or the user left)"
                  )
                  .setDescription(
                    `Close this ticket with: \`${config.prefix}forceclose\`\nAfter that, you can safely delete this channel!`
                  ),
              ],
            })
            .catch(console.error);
              ...
              .reply({
                embeds: [
                  new Discord.MessageEmbed()
                    ...
                    .setTitle("❌ The user left the server.")
                    .setDescription(
                      `Close this ticket with: \`${config.prefix}close\``
                    ),
                ],
              })
              .catch(console.error);
        ...
        if (message.attachments.size > 0) {
          if (
            ["png", "jpeg", "jpg", "gif"].some((i) =>
              message.attachments.first()?.url?.toLowerCase()?.includes(i)
            )
          ) {
            attachment = [
              new Discord.MessageAttachment(message.attachments.first()?.url),
            ];
          } else {
            attachment = [];
          }
        ...
        let embed = new Discord.MessageEmbed()
          ...
          .addField(
            `Highest Role:`,
            `${message.member.roles.highest.name} | \`${message.member.roles.highest.id}\``
          );
                ...
                embeds: [
                  new Discord.MessageEmbed()
                    ...
                    .setDescription(
                      `\`\`\`${
                        error.message
                          ? String(error.message).substr(0, 2000)
    ...
    if (!message.guild || message.channel.type == "DM") {
      ...
      if (!client.modmailDb.has(dmauthor.id)) {
        ...
        if (guildsin.length == 0) {
            ...
            .reply({
              embeds: [
                new Discord.MessageEmbed()
                  .setAuthor(
                    dmauthor.tag,
                    dmauthor.displayAvatarURL({ dynamic: true })
                  )
                  .setTimestamp()
                  .setFooter(
                    `ID: ${dmauthor.id}`,
                  ...
                  .setColor("RED")
                  .setTitle("❌ You are not sharing any servers with me!")
                  .setDescription(
                    `[Join TCA's Axolotl Club](https://discord.gg/8HCtqsgPwE)`
                  ),
              ],
            })
            .catch(console.error);
              ...
              .reply({
                embeds: [
                  new Discord.MessageEmbed()
                    ...
                    .setColor("RED")
                    .setTitle(
                      "❌ Could not find the guild under this ID!! (IF YOU TRY TO SEND ONE)"
                    )
                    .setDescription(
                      `**Did you add a valid ID?** <Check out my Example ID! \`${guildsin[0]}\`>`
                    ),
                ],
              })
              .catch(console.error);
          ...
          let embed = new Discord.MessageEmbed()
            ...
            .setColor("BLURPLE")
            .setTitle("✅ All servers we are in!")
            .setDescription(
              String(
                guildsin
                  .map(
            ...
            .setFooter(
              "Note: If the server you want to contact is not showing up, then just send the ID of the server you want to contact!"
            );
          message.reply({
            embeds: [
              embed,
              new Discord.MessageEmbed()
                ...
                .setColor("GREEN")
                .setTitle("👍 Select which server you want to contact!")
                .setDescription(
                  `**Please send the ID of the SERVER you want to contact!**\n\n**Example:**\n> \`${guildsin[0]}\``
                ),
            ],
          });
        }
      ...
      //SUPPORT MESSAGES ETC.
        ...
        let guild = client.guilds.cache.get(
          client.modmailDb.get(dmauthor.id, "id")
        );
        if (!guild) {
          return message
            .reply({
        ...
        let channel = guild.channels.cache.get(
          client.modmailDb.get(dmauthor.id, "channel")
        );
        if (!channel) {
          return message
            .reply({
              embeds: [
                new Discord.MessageEmbed()
                  ...
                  .setColor("RED")
                  .setTitle(
                    "❌ Unable to find the support channel, try again!"
                  ),
              ],
              components: [
                new Discord.MessageActionRow().addComponents(
                  new Discord.MessageButton()
                    ...
                    .setCustomId("force_modmail_close")
                    .setEmoji("❎")
                ),
              ],
            })
  ...
  client.on("interactionCreate", async (interaction) => {
    if (
      ...
      interaction.customId == "close_modmail_ticket" &&
      !interaction.guildId
    ) {
        ...
        .send({
          ...
          embeds: [
            new Discord.MessageEmbed()
              ...
              .setColor("GREEN")
              .setTitle("✅ TicketUser Closed the Ticket")
              .setDescription(`You can now safely delete this channel!`),
          ],
        })
        .catch(console.error);
      try {
        fs.unlinkSync(`${process.cwd()}/${channel.name}.html`);
      } catch (e) {
        console.log(e);
      }
    }
    if (
      interaction.isButton() &&
      interaction.customId == "force_modmail_close" &&
      !interaction.guildId
    ) {
      if (client.modmailDb.has(interaction.user.id))
        client.modmailDb.delete(interaction.user.id);
      interaction.reply({
    ...
    if (
      ...
      let authorId = client.modmailDb.findKey(
        (d) =>
          d.id == interaction.message.guild.id &&
          d.channel == interaction.message.channel.id
      );
      if (!authorId)
        return interaction
          .reply({
      ...
      if (!author)
        author = await interaction.message.guild.members
          .fetch(authorId)
          .catch((e) => {
            console.log(e);
            return interaction
      ...
      //The text content collection
      let messageCollection = new Discord.Collection(); //make a new collection
      let channelMessages = await interaction.message.channel.messages
        .fetch({
          //fetch the last 100 messages
          limit: 100,
        })
      ...
      while (channelMessages.size === 100) {
        ...
        tomanymsgs += 1; //add 1 to the counter
        let lastMessageId = channelMessages.lastKey(); //get key of the already fetched messages above
        channelMessages = await interaction.message.channel.messages
          .fetch({
            limit: 100,
            before: lastMessageId,
          })
  ...
  client.on("channelDelete", (channel) => {
    if (channel.guild) {
      let authorId = client.modmailDb.findKey(
        (d) => d.id == channel.guild.id && d.channel == channel.id
      );
      if (authorId) client.modmailDb.delete(authorId);
    }
  });
  ...
  function startSupportProcess(guild, message, dmauthor) {
        ...
        .reply({
          embeds: [
            new Discord.MessageEmbed()
              ...
              .setDescription(
                `an admin can do it with \`${config.prefix}setup\``
              ),
          ],
        })
        .catch(console.error);
    ...
    guild.channels
      .create(`${dmauthor.username}`.substr(0, 32), {
        type: "GUILD_TEXT",
                ...
                .addField(
                  ...
                  `${
                    !category
                      ...
                      : "Using the Settings of it's Category"
                  }`
                ),
            ],
            components: [
              new Discord.MessageActionRow().addComponents(
                new Discord.MessageButton()
                  ...
                  .setCustomId("close_modmail_ticket")
              ),
            ],
          })
          .catch(console.error);
